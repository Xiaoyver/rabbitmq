...
@Slf4j
@Component
public class RabbitMqListenerFactoryInit implements CommandLineRunner {
    ...
    private static List<RabbitMqListenerEntity> list = new ArrayList<>();

    static {
        list.add(RabbitMqListenerEntity
                .builder()
    ...
    public void run(String... args) throws Exception {
        ...
        list.forEach(rabbitMqListenerEntity -> rabbitMqUtils.addListener(rabbitMqListenerEntity));
